...
#SBATCH -o DiT_edm_learn_curve_ESM_%A_%a.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e DiT_edm_learn_curve_ESM_%A_%a.err  # File to which STDERR will be written, %j inserts jobid
#SBATCH --mail-user=binxu_wang@hms.harvard.edu

echo "$SLURM_ARRAY_TASK_ID"
param_list=\
'--dataset_name ffhq-32x32                     --exp_name FFHQ32_DiT_P2_192D_3H_6L_EDM_pilot    --patch_size 2 --hidden_size 192 --depth 6 --num_heads 3 --mlp_ratio 4 --eval_sample_size 2048 --eval_batch_size 1024  --lr 1e-4 --nsteps 50000 --batch_size 256  
...
--dataset_name ffhq-32x32    --loss_type ESM   --exp_name FFHQ32_DiT_P2_384D_6H_6L_EDM_pilot_ESM    --patch_size 2 --hidden_size 384 --depth 6 --num_heads 6 --mlp_ratio 4 --eval_sample_size 2048 --eval_batch_size 1024  --lr 1e-4 --nsteps 50000 --batch_size 256    --eval_fix_noise_seed
--dataset_name ffhq-32x32    --loss_type DSM   --exp_name FFHQ32_DiT_P2_384D_6H_6L_EDM_pilot_DSM    --patch_size 2 --hidden_size 384 --depth 6 --num_heads 6 --mlp_ratio 4 --eval_sample_size 2048 --eval_batch_size 1024  --lr 1e-4 --nsteps 50000 --batch_size 256    --eval_fix_noise_seed
--dataset_name ffhq-32x32    --loss_type ESM   --exp_name FFHQ32_DiT_P2_192D_3H_6L_EDM_pilot_ESM    --patch_size 2 --hidden_size 192 --depth 6 --num_heads 3 --mlp_ratio 4 --eval_sample_size 2048 --eval_batch_size 1024  --lr 1e-4 --nsteps 50000 --batch_size 256    --eval_fix_noise_seed
--dataset_name ffhq-32x32    --loss_type DSM   --exp_name FFHQ32_DiT_P2_192D_3H_6L_EDM_pilot_DSM    --patch_size 2 --hidden_size 192 --depth 6 --num_heads 3 --mlp_ratio 4 --eval_sample_size 2048 --eval_batch_size 1024  --lr 1e-4 --nsteps 50000 --batch_size 256    --eval_fix_noise_seed
'
...
python experiment/DiT_learn_curve_CLI.py --record_frequency 0 --eval_sampling_steps 35 \
    $param_name
