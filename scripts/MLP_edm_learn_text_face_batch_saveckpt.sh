...
param_list=\
'--dataset_name  ffhq-32x32                      --exp_name FFHQ32_UNet_MLP_EDM_8L_3072D_lr1e-4_saveckpt_fewsample                     --record_step_range 0 50000 500  --eval_sample_size 2048 --eval_batch_size 2048  --lr 1e-4 --nsteps 50000 --batch_size 256  --mlp_layers 8 --mlp_hidden_dim 3072 --mlp_time_embed_dim 128
