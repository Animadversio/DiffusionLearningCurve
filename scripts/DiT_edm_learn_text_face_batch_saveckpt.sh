...
--dataset_name words32x32_50k_BW               --exp_name words32x32_50k_BW_DiT_P2_192D_3H_6L_EDM_saveckpt_fewsample     --patch_size 2 --hidden_size 192 --depth 6 --num_heads 3 --mlp_ratio 4 --eval_sample_size 2048 --eval_batch_size 1024  --lr 1e-4 --nsteps 50000 --batch_size 256  
