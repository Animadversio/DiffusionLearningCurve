...
#SBATCH -o unet_resnet_edm_learn_batch_%A_%a.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e unet_resnet_edm_learn_batch_%A_%a.err  # File to which STDERR will be written, %j inserts jobid
#SBATCH --mail-user=binxu_wang@hms.harvard.edu

echo "$SLURM_ARRAY_TASK_ID"
param_list=\
'--dataset_name  ffhq-32x32           --exp_name FFHQ32_ResNet_CNN_EDM_1layers_wide128  --model_channels 128 --layers_per_block 1  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_2layers_wide128  --model_channels 128 --layers_per_block 2  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_3layers_wide128  --model_channels 128 --layers_per_block 3  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_1layers_wide256  --model_channels 256 --layers_per_block 1  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_3layers_wide256  --model_channels 256 --layers_per_block 3  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_1layers_wide4     --model_channels 4 --layers_per_block 1  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_1layers_wide8     --model_channels 8 --layers_per_block 1  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_1layers_wide32    --model_channels 32 --layers_per_block 1  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_1layers_wide6     --model_channels 6 --layers_per_block 1  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_1layers_wide12     --model_channels 12 --layers_per_block 1  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_1layers_wide16     --model_channels 16 --layers_per_block 1  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256 
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_3layers_wide6     --model_channels 6 --layers_per_block 3  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_2layers_wide6     --model_channels 6 --layers_per_block 2  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
--dataset_name  ffhq-32x32            --exp_name FFHQ32_ResNet_CNN_EDM_5layers_wide6     --model_channels 6 --layers_per_block 5  --eval_sample_size 2000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  
'
...
python experiment/CNN_resnet_learn_curve_CLI.py --record_frequency 0 --eval_fix_noise_seed \
    $param_name
