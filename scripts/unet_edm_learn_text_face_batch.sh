...
--dataset_name  ffhq-32x32     --loss_type ESM  --exp_name FFHQ32_UNet_CNN_EDM_4blocks_wide128_attn_pilot_fixednorm_ESM                       --decoder_init_attn True  --eval_sample_size 1000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  --model_channels 128 --channel_mult 1 2 2 2 --attn_resolutions 8 
--dataset_name  ffhq-32x32     --loss_type DSM  --exp_name FFHQ32_UNet_CNN_EDM_4blocks_wide128_attn_pilot_fixednorm_DSM                       --decoder_init_attn True  --eval_sample_size 1000 --eval_batch_size 512  --lr 1e-4 --nsteps 50000 --batch_size 256  --model_channels 128 --channel_mult 1 2 2 2 --attn_resolutions 8 
'
