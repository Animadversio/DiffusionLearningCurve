...
python experiment/unet_FFHQ_learn_curve_CLI.py --exp_name words32x32_50k_UNet_CNN_EDM_4blocks_noattn \
...
cd ~/Github/DiffusionLearningCurve
python experiment/unet_FFHQ_learn_curve_CLI.py --exp_name FFHQ_fix_words_UNet_CNN_EDM_4blocks_wide128_attn_pilot_fixednorm \
...
cd ~/Github/DiffusionLearningCurve
python experiment/unet_FFHQ_learn_curve_CLI.py --exp_name FFHQ_random_words_UNet_CNN_EDM_4blocks_wide128_attn_pilot_fixednorm \
...
cd ~/Github/DiffusionLearningCurve
python experiment/unet_FFHQ_learn_curve_CLI.py --exp_name FFHQ_UNet_CNN_EDM_4blocks_wide128_attn_pilot_fixednorm \
    --dataset_name FFHQ \
    --decoder_init_attn True --record_frequency 0  --eval_sample_size 1000 --eval_batch_size 512 \
    --lr 1e-4 --nsteps 50000 --batch_size 256 \
    --model_channels 128 --channel_mult 1 2 2 2 --attn_resolutions 8 
